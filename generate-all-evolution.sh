...
java -jar graphlets-over-time.jar 1 hepth 18477 1069 136190
java -jar graphlets-over-time.jar 1 enron 55655 1335 1918412
java -jar graphlets-over-time.jar 1 email-eu 986 211 24929
java -jar graphlets-over-time.jar 1 college_msg 1899 137 20296
java -jar graphlets-over-time.jar 1 mathoverflow 21688 969 506551
java -jar graphlets-over-time.jar 1 askubuntu 137517 1954 964438

# Running below datasets takes more than 1 hour.
